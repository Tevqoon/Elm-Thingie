...
var $author$project$App$Double = {$: 'Double'};
var $author$project$App$Increment = {$: 'Increment'};
var $author$project$App$Initialize = {$: 'Initialize'};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(model.value * 3))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$App$Double)
							]))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$App$Initialize)
					]),
				_List_fromArray(
					[
